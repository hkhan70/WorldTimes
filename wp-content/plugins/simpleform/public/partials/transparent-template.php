...
// Submit field
$form .= '<div id="sform-submit-wrap" class="'.$submit_class.'"><button name="submission" id="submission" type="submit" class="'.$button_class.'">'.$submit_label.'</button>'.$animation.'</div></form>'; 
